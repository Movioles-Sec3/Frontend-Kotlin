...
import app.src.data.local.dao.InsightsDao
 ...
 * Contiene 6 capas de almacenamiento:
 ...
 * 6. Insights (Business Questions y análisis de patrones de compra)
 */
@Database(
    entities = [
        OrderEntity::class,
    ...
    version = 7, // ✅ INCREMENTADO de 6 a 7 por agregar imagenUrl a OrderItemEntity
    exportSchema = false
)
